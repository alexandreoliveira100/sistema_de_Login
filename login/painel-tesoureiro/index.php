...
if (@$_SESSION['nivel_usuario'] != 'Tesoureiro') { //o @ antes do $_SESSION é para ignorar a mensagem warnig que aparece
...
<head>
    ...
    <title>Painel do Tesoureiro</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Tesoureiro</a>
...
<header>
<h1 style="text-align: center"> PAINEL DO TESOUREIRO</h1>  
</header>
