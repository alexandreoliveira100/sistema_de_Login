...
//VERIFICAR SE O USUÁRIO LOGADO É UM ADMINISTRADOR
   //(@$_SESSION['nivel_usuario'] != 'Cliente') 
if (@$_SESSION['nivel_usuario'] != 'Vendedor') { //o @ antes do $_SESSION é para ignorar a mensagem warnig que aparece
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Vendedor</a>
...
<header>
<h1 style="text-align: center"> PAINEL DE VENDEDOR</h1>  
</header>
